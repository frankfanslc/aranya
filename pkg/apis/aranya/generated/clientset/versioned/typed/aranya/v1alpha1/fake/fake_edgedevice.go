...
type FakeEdgeDevices struct {
	Fake *FakeAranyaV1alpha1
	ns   string
}

var edgedevicesResource = schema.GroupVersionResource{Group: "aranya.arhat.dev", Version: "v1alpha1", Resource: "edgedevices"}

var edgedevicesKind = schema.GroupVersionKind{Group: "aranya.arhat.dev", Version: "v1alpha1", Kind: "EdgeDevice"}
