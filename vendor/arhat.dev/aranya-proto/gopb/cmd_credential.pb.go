...
var fileDescriptor_ca060e42f44d1ee8 = []byte{
	...
	0x56, 0x3a, 0x05, 0x5e, 0x78, 0x28, 0xc7, 0x70, 0xe3, 0xa1, 0x1c, 0xc3, 0x87, 0x87, 0x72, 0x8c,
	...
	0x39, 0x86, 0x0b, 0x8f, 0xe5, 0x18, 0x6e, 0x3c, 0x96, 0x63, 0x88, 0x92, 0x4e, 0x2c, 0xca, 0x48,
	0x2c, 0xd1, 0x4b, 0x49, 0x2d, 0xd3, 0x87, 0x84, 0x81, 0x2e, 0x38, 0xcc, 0xf5, 0xd3, 0xf3, 0x0b,
	0x92, 0x92, 0xd8, 0xc0, 0x6c, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0x53, 0x95, 0x53, 0x05,
	0x97, 0x01, 0x00, 0x00,
}
...
func (this *CredentialCmd_Storage) GoString() string {
	...
	s := strings.Join([]string{`&gopb.CredentialCmd_Storage{` +
...
func (this *StorageCredentialOptions) GoString() string {
	...
	s := make([]string, 0, 5)
	s = append(s, "&gopb.StorageCredentialOptions{")
