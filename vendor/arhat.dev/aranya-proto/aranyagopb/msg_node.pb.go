...
func (NodeExtInfo_Target) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_5478f2830667bf7c, []int{4, 2}
}
...
type NodeSystemInfo struct {
	...
	RuntimeInfo   *NodeContainerRuntimeInfo `protobuf:"bytes,21,opt,name=runtime_info,json=runtimeInfo,proto3" json:"runtime_info,omitempty"`
}
...
var fileDescriptor_5478f2830667bf7c = []byte{
	...
	,
}
...
func (m *NodeExtInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.TargetKey) > 0 {
		...
		i = encodeVarintMsgNode(dAtA, i, uint64(len(m.TargetKey)))
		i--
		dAtA[i] = 0x2a
	}
	if m.Target != 0 {
		i = encodeVarintMsgNode(dAtA, i, uint64(m.Target))
		i--
		dAtA[i] = 0x20
	}
	if m.Operator != 0 {
...
func (m *NodeExtInfo) Size() (n int) {
	...
	if m.Target != 0 {
		n += 1 + sovMsgNode(uint64(m.Target))
	}
	l = len(m.TargetKey)
	if l > 0 {
		n += 1 + l + sovMsgNode(uint64(l))
