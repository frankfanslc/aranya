...
var fileDescriptor_f641e3fb62eff8eb = []byte{
	...
	0x85, 0x5f, 0x78, 0x28, 0xc7, 0x70, 0xe3, 0xa1, 0x1c, 0xc3, 0x87, 0x87, 0x72, 0x8c, 0x0d, 0x8f,
	...
	0x0b, 0x8f, 0xe5, 0x18, 0x6e, 0x3c, 0x96, 0x63, 0x88, 0x52, 0x4c, 0x2c, 0xca, 0x48, 0x2c, 0xd1,
	0x4b, 0x49, 0x2d, 0xd3, 0x87, 0xf8, 0x43, 0x17, 0xec, 0x7b, 0x28, 0x27, 0x3d, 0xbf, 0x20, 0x29,
	0x89, 0x0d, 0x2c, 0x62, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0x6a, 0x88, 0xb2, 0xe9, 0x24, 0x01,
	0x00, 0x00,
}
...
func (this *SessionCmd) GoString() string {
	...
	s := make([]string, 0, 6)
	s = append(s, "&aranyagopb.SessionCmd{")
...
func (this *SessionCmd_SessionId) GoString() string {
	...
	s := strings.Join([]string{`&aranyagopb.SessionCmd_SessionId{` +
