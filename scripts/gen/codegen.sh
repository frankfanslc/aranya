...
install_deepcopy_gen() {
  _install_go_bin "k8s.io/code-generator@v0.19.6" "./cmd/client-gen" "${GOPATH}/bin/client-gen"
  _install_go_bin "k8s.io/code-generator@v0.19.6" "./cmd/lister-gen" "${GOPATH}/bin/lister-gen"
  _install_go_bin "k8s.io/code-generator@v0.19.6" "./cmd/informer-gen" "${GOPATH}/bin/informer-gen"
}
